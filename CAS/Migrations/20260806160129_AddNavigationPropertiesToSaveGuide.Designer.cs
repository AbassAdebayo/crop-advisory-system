...
namespace CAS.Migrations
{
    ...
    [Migration("20260806160129_AddNavigationPropertiesToSaveGuide")]
    partial class AddNavigationPropertiesToSaveGuide
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CAS.Models.Entities.Advisory", b =>
                {
                    b.HasOne("CAS.Models.Entities.Crop", "Crop")
                        .WithMany("Advisories")
                        .HasForeignKey("CropId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CAS.Models.Entities.Season", "Season")
                        .WithMany("Advisories")
                        .HasForeignKey("SeasonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CAS.Models.Entities.SoilType", "SoilType")
                        .WithMany("Advisories")
            ...
            modelBuilder.Entity("CAS.Models.Entities.SaveGuide", b =>
                {
                    b.HasOne("CAS.Models.Entities.Advisory", "Advisory")
                        .WithMany()
                        .HasForeignKey("AdvisoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CAS.Models.Entities.User", "User")
                        .WithMany()
